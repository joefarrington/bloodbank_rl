...
python3 run_pyomo_smilp.py model_constructor=sSbQ_PyomoModelConstructor n_scenarios=10 +solver_options.mipgap=0.05 model_constructor_params.weekly_policy=True