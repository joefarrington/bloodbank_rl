...
python3 run_pyomo_smilp.py model_constructor=sS_PyomoModelConstructor n_scenarios=20 +solver_options.TimeLimit=129600 model_constructor_params.weekly_policy=True